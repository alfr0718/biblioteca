        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/user/index">Registro</a>
                        <a class="collapse-item" href="/datospersonales/index">Estudiantes</a>
                        <a class="collapse-item" href="cards.html">Resetear contraseña</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">RBAC:</h6>
                        <a class="collapse-item" href="/rbac/role">Roles</a>
                        <a class="collapse-item" href="/rbac/route">Rutas</a>
                        <a class="collapse-item" href="/rbac/assignment">Asignados</a>
                        <a class="collapse-item" href="/rbac/permission">Permisos</a>
                    </div>
                </div>
            </li>
