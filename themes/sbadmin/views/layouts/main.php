        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Recursos Digitales</a>
                        <a class="collapse-item" href="cards.html">Busqueda Avanzada</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Iniciar Sesión:</h6>
                        <a class="collapse-item" href="/site/login">Iniciar Sesión</a>
                        ...
                        <?php else : ?>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle" src="sbadminassets/img/undraw_profile.svg">
                                </a>
