...
<div class="datospersonales-index">
    ...
    <p>
        <?php if (!Yii::$app->user->isGuest && Yii::$app->user->can('admin')) {
            ...
            echo    Html::a(
                '<span class="icon text-white-100"><i class="fas fa-plus-circle"></i></span><span class="text">Agregar Registro</span>',
                ['create'],
                ['class' => 'btn btn-success btn-icon-split'] +$commonOptions
            );

            echo    Html::a(
                '<span class="icon text-white-100"><i class="fas fa-users"></i></span><span class="text">Cuentas</span>',
                ['user/index'],
                ['class' => 'btn btn-primary btn-icon-split'] +$commonOptions
            );
        } ?>
    </p>
